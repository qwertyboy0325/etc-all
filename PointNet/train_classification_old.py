...
def main(args):
    ...
    # data_path = 'data/modelnet40_normal_resampled/ModelNet40/'
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        for batch_id, (points, target) in tqdm(enumerate(trainDataLoader, 0), total=len(trainDataLoader), smoothing=0.9):
            ...
            points[:, :, 0:3] = provider.random_scale_point_cloud(points[:, :, 0:3]) # Teng's comments: Note that this scale is unnecessary for our application
        ...
        end_time = time.perf_counter()
        execution_time = end_time - start_time
        print(f"Training 時間 for an epoch: {execution_time:.6f} 秒")
...
if __name__ == '__main__':
    ...
    # --model pointnet_cls --log_dir pointnet_cls --gpu 0 --epoch 200 --process_data --use_uniform_sample

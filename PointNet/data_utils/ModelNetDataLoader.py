...
class ModelNetDataLoader(Dataset):
    def __init__(self, root, args, split='train', process_data=False):
        ...
        if self.sampler == 'farthest':
            ...
            self.save_path = os.path.join(root, 'modelnet%d_%s_%dpts_rs.dat' % (self.num_category, split, self.npoints))
        elif self.sampler == 'uniform':
            self.save_path = os.path.join(root, 'modelnet%d_%s_%dpts_us.dat' % (self.num_category, split, self.npoints))
